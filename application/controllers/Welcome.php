...
$total_records = $this->tindakan->get_total();
if(!empty($kw)){
$total_records = $this->tindakan->get_total_search($kw);
}

if($total_records>0){
//get current page records
$data["records"] = $this->tindakan->pagination($limit_per_page,$start_index);
if(!empty($kw)){
$data["records"] = $this->tindakan->search($kw,$limit_per_page,$start_index);
}
...
$this->load->view('welcome_message',$data);
	...
	function detail(){
        ...
        $data = $this->tindakan->find_by_id($No_reg);
